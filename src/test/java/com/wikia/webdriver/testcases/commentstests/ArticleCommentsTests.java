...
public class ArticleCommentsTests extends NewTestTemplate {
  ...
  @Test(groups = {"ArticleComments_001", "ArticleComments", "Smoke2"}, invocationCount=25)
  ...
  @Test(groups = {"ArticleComments_002", "ArticleComments"}, invocationCount=25)
  ...
  @Test(groups = {"ArticleComments_003", "ArticleComments"}, invocationCount=25)
  ...
  @Test(groups = {"ArticleComments_004", "ArticleComments"}, invocationCount=25)
