...
public class BlogFeaturesTests extends NewTestTemplate {
  ...
  @Test(groups = {"BlogFeatures_001", "BlogFeaturesTests"}, invocationCount=25)
  ...
  @Test(groups = {"BlogFeatures_002", "BlogFeaturesTests"}, invocationCount=25)
  ...
  @Test(groups = {"BlogFeatures_003", "BlogFeaturesTests"}, invocationCount=25)
  ...
  @Test(groups = {"BlogFeatures_004", "BlogFeaturesTests", "Media"}, invocationCount=25)
  ...
  @Test(groups = {"BlogFeatures_005", "BlogFeaturesTests"}, invocationCount=25)
